...
… is the inability to share private module variables across module extensions.
… countScrolls function is created in a completely different scope than the countClicks function… with a completely new set of private variables.
.. countScrolls can’t access the numClicks and handleClick variables
